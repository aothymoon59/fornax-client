    ...
    const navItems = (
        <>
            ...
            <li className="block lg:hidden">
                <a className="default">About Us</a>
                <ul className="p-2">
                    <li><Link to='/about' aria-label="About Us">About Us</Link></li>
                    <li><Link to='/team' aria-label="Team">Team</Link></li>
                </ul>
            </li>
            ...
            <li tabIndex={0} className="hidden lg:block">
                <details>
                    ...
                    <ul className="p-[10px] rounded-xl bg-[#102642] w-[250px]">
                        <li>
                            <Link to='/about' aria-label="About Us" title="Fornax or non-fungible tokens, are unique and irreplaceable" className='px-[10px] py-4 hover:bg-[#1D375899] rounded-[10px] flex items-center gap-[10px]'>
        ...
        <div className="w-full dark-bg z-50">
            <Container>
                <div className="navbar py-5">
                    ...
                    <div className="navbar-end gap-5 font-montserrat">
                        {/* currency change  */}
